...
└─────────────────────┼────────────────┼───────────────────┘
                      ...
                      ▼                ▼
        ┌───────────────────┐  ┌──────────────────────────┐
        │  Google Search    │  │    Gemini 2.5 Flash      │
        │  Grounding        │  │    Native Audio          │
        │                   │  │                          │
        │  • Reliable       │  │  • Real-time voice I/O   │
        │    sources for    │  │  • Barge-in support      │
        │    curriculum     │  │  • Tool calling          │
        │    generation     │  │  • Context-aware dialog  │
        └───────────────────┘  └──────────────────────────┘
```
